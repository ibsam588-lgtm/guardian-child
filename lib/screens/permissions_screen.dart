...
class _PermissionsScreenState extends State<PermissionsScreen> {
    ...
    Future<void> _checkAccessibility() async {
          final granted = await MonitorService().hasAccessibilityPermission();
          setState(() => _accessibilityGranted = granted);
    }

    Future<void> _requestAccessibility() async {
          await MonitorService().openAccessibilitySettings();
    }
                                        ...
                                        child: Column(
                                                      ...
                                                      children: [
                                                                      ...
                                                                      _PermissionItem(
                                                                                        ...
                                                                                        onRequest: () async {
                                                                                                            setState(() => _requesting = true);
                                                                                                            await _monitorChannel.invokeMethod('openUsageStatsSettings');
                                                                      ...
                                                                      _PermissionItem(
                                                                                        ...
                                                                                        description: 'Prevent battery optimization interference',
                                                                                        isGranted: false,
                                                                                        onRequest: () async {
                                                                                                            setState(() => _requesting = true);
                                                                                                            await _monitorChannel.invokeMethod('openBatteryOptimization');
                                                                                                            setState(() => _requesting = false);
                                                                                        },
                                                                                      ),
                                                                      const SizedBox(height: 16),
                                                                      _PermissionItem(
                                                                                        ...
                                                                                        description: 'Read call logs and text messages for parental monitoring',
                                                                      ...
                                                                      _PermissionItem(
                                                                                        ...
                                                                                        description: 'Track browser activity using accessibility service',
                                                                      ...
                                                                      SizedBox(
                                                                                        ...
                                                                                        child: ElevatedButton(
                                                                                                            onPressed: _requesting ? null : () => context.go('/pairing'),
                            ...
                            children: [
                                        ...
                                        Expanded(
                                                      child: Column(
                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                      children: [
                                                                                        Text(title, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color: Color(0xFFDDDDDD))),
                                                                                        Text(subtitle,
                                                                                                                 style: TextStyle(
                                                                                                                                         fontSize: 12,
